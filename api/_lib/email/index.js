...
// imports `sendEmail` from HERE, never from a specific provider file.
//
// CHANGED: now points at brevo.js. brevo.js was already added to this
// project (300 free emails/day, no monthly expiry) but this file was
// still importing from resend.js — meaning every send was using
// whichever provider you *didn't* set an API key for, and failing
// silently. Make sure BREVO_API_KEY and EMAIL_FROM are set in Vercel.
//
